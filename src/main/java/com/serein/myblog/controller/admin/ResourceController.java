...
public class ResourceController {
    ...
    public String pictures(Model model, @RequestParam(defaultValue = "1",value = "pageNum") Integer pageNum) {
        ...
        List<IResources> listResources = resourceService.listResources();
        PageInfo<IResources> pageInfo = new PageInfo<IResources>(listResources);
    ...
    public String input(Model model) {
        model.addAttribute("resource", new IResources());
    ...
    public String post(@Valid IResources resources, BindingResult result, RedirectAttributes attributes){
    ...
    public String editPost(@Valid IResources resources, RedirectAttributes attributes) {
    ...
    public String is_published(@PathVariable Long id, RedirectAttributes attributes){
        ...
        IResources resources = resourceService.getResource(id);
